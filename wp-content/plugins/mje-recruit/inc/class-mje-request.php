...
class MJE_Request extends AE_Post_Custom{
    ...
    function convert($post, $thumbnail = 'medium_post_thumbnail', $excerpt = true, $singular = false){
        ...
        $post->number_offers_txt = sprintf(__('%s offers','enginethemes'),$post->number_offers);
        $post->date_txt =  sprintf(__('Posted %s','enginethemes'), date( get_option('date_format'),  strtotime($post->post_date) ) );
	...
	function register_post_type(){
		$labels = array(
			'name'               => _x( 'Recruit', 'post type general name', 'your-plugin-textdomain' ),
			...
			'add_new_item'       => __( 'Add New Recruitment', 'your-plugin-textdomain' ),
			'new_item'           => __( 'New recruitment', 'your-plugin-textdomain' ),
			'edit_item'          => __( 'Edit', 'your-plugin-textdomain' ),
			'view_item'          => __( 'View recruitment', 'your-plugin-textdomain' ),
			'all_items'          => __( 'All recruitments', 'your-plugin-textdomain' ),
			'search_items'       => __( 'Search recruitments', 'your-plugin-textdomain' ),
			'parent_item_colon'  => __( 'Parent recruitment', 'your-plugin-textdomain' ),
			'not_found'          => __( 'No Recruitment post found.', 'your-plugin-textdomain' ),
			'not_found_in_trash' => __( 'No recruitment found in the trashh.', 'your-plugin-textdomain' )
		);
        ...
        $labels = array(
            ...
            'parent_item_colon'  => __( 'Parent Offer', 'your-plugin-textdomain' ),
