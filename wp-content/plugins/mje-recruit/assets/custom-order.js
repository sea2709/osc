...
(function($, Models, Collections, Views) {
    var cs_order = {fromUser:0,toUser:0,mJob:0,mjob_name:''};

    $(document).ready(function() {
        //Get user login
        //var offers = JSON.parse($('.json_offers').html());
        var offers = JSON.parse(jQuery('#json_offers').html())

        var conversationParent = '';
        var conversationGuid = '';


        $('#customOrderModal .mjob-name').text(cs_order.mjob_name);
        /**
         ...
         * @author Dang Bui
         */
        Views.CustomOrderofRecruit = Backbone.View.extend({
            el: 'body',
            events: {
            ...
            modalCustom: function (event) {
                ...
                cs_order.fromUser = target.attr('data-from-user');
                cs_order.toUser = target.attr('data-to-user');
                cs_order.mJob = target.attr('mjob_id');
                cs_order.mjob_name = target.attr('mjob_name');
                conversationParent = target.attr('data-conversation-parent');
                conversationGuid =target.attr('data-conversation-guid');
        ...
        Views.ModalCustom = Views.Modal_Box.extend({
            ...
            initialize: function () {
                ...
                if (typeof this.model === 'undefined') {
                    ...
                    this.model.set('from_user', cs_order.fromUser);
                    this.model.set('to_user', cs_order.toUser);
                    console.log(conversationParent);
                    ...
                    this.model.set('mjob', cs_order.mJob);
        ...
        console.log('custom-order.js Run')
        new Views.CustomOrderofRecruit();
