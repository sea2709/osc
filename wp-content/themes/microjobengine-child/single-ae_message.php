                    ...
                    <div class="compose-conversation mjob-conversation-form">
                        <form>
                            ...
                            <div class="form-group compose">
                                <div class="attachment-file gallery_container_single_conversation" id="message_modal_gallery_container" aaaa>
                                    <!-- attachments list-->
                                    ...
                                    <div class="group-compose">
                                        ...
                                        <div class="action-link">
                                            <div class="attachment-image">
                                                <span class="plupload_buttons" id="carousel_single_conversation_container" data-upload="s3">
                                        ...
                                        <div class="progress" id="carousel_single_conversation_progress"></div>
