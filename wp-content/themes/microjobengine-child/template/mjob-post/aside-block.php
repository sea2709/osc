...
<div class="box-shadow box-aside-stat">
        ...
        <div class="stat-block">
            <ul>
                ...
                <li class="clearfix">
                    ...
                    <div class="total-number time-delivery-label pull-right"><?php echo $mjob_post->time_delivery; ?> day(s)</div>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="custom-order-link">
        ...
        if( $user_ID != $mjob_post->post_author ) {
            ...
            ?>
            <div>
                <a id="<?php echo $send_custom_order_id; ?>" class="<?php echo $class_link_order;?> waves-effect waves-light btn-submit-o" data-mjob-name="<?php echo $mjob_post->post_title; ?>" data-mjob="<?php echo $mjob_post->ID ?>" data-conversation-guid="<?php echo $conversation_guid; ?>" data-conversation-parent="<?php echo $conversation_parent; ?>" data-to-user="<?php echo $mjob_post->post_author; ?>" data-from-user="<?php echo $user_ID ?>" style="cursor: pointer"><?php _e('Send custom order','enginethemes'); ?><i class="fa fa-paper-plane"></i></a>
            </div>
            <?php
        }
        ?>
