...
<div class="frame-delivery-info">
    ...
    <div class="file-attachment">
        ...
        <?php elseif (!empty( $mjob_order->order_delivery['0']->attachments)) : ?>
            <ul class="list-file">
                <?php foreach($mjob_order->order_delivery['0']->attachments as $key=> $value ): ?>
                    <li class="image-item">
                        <a href="<?php echo $value['url'];?>">
                            <i class="fa fa-paperclip"></i> <?php echo $value['name']; ?>
                        </a>
                    </li>
                <?php endforeach; ?>
            </ul>
