...
class AE_Mailing extends AE_Base
{
    ...
    function forgot_mail($user_id, $key) {
        ...
        $activate_url = '<a style="background:#10a2ef;border-radius:45px;color:#FFFFFF;padding: 13px 16px;text-decoration: none;width: 200px;text-align: center; display: inline-block;" href="' . $activate_url . '">' . __("Recover Link", 'enginethemes') . '</a>';
    ...
    function filter_authentication_placeholder($content, $user_id) {
        ...
        $confirm_link = '<a style="background:#10a2ef;border-radius:45px;color:#FFFFFF;padding: 13px 16px;text-decoration: none;width:200px;text-align:center;display:inline-block;" href="' . $confirm_link . '" >' . __("Confirm link", 'enginethemes') . '</a>';
