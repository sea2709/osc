...
class MJE_Mailing extends AE_Mailing
{
    ...
    public function notify_new_mjob_post($postID) {
        ...
        $post_link = '<a style="background:#10a2ef;border-radius:45px;color:#FFFFFF;padding: 13px 16px;text-decoration: none;" href="' . get_permalink($postID) . '" >'. __('here', 'enginethemes') .'</a>';
    ...
    public function notify_payment($order) {
        ...
        $link = '<a style="background:#10a2ef;border-radius:45px;color:#FFFFFF;padding: 13px 16px;text-decoration: none;" href="' . get_permalink($order->ID) . '">' . get_the_title($order->ID) . '</a>';
...
//        Get mjob name
    ...
    public function filter_order_placeholder($message, $order) {
        ...
        $order_link = '<a style="background:#10a2ef;border-radius:45px;color:#FFFFFF;padding: 13px 16px;text-decoration: none;" href="'. $order_permalink .'">'. __('View order', 'enginethemes') . '</a>';
